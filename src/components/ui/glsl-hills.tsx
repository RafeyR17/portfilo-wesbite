        ...
        class Plane {
            ...
            constructor() {
                ...
                this.geometry = new PlaneGeometry(
                    planeSize,
                    planeSize,
                    Math.min(planeSize, 128), // Cap segments for performance
                    Math.min(planeSize, 128)
                );
                this.material = new RawShaderMaterial({
                    ...
                    fragmentShader: /* glsl */ `
                        ...
                        void main(void) {
                            ...
                            vec3 basePurple = vec3(0.40, 0.10, 0.60);
                            vec3 accentPurple = vec3(0.75, 0.45, 1.0);
                            float heightFactor = smoothstep(-20.0, 50.0, vPosition.y);
                            vec3 color = mix(basePurple, accentPurple, heightFactor * 0.6);
                            gl_FragColor = vec4(color, opacity * 0.85);
                        }
                    `,
                    transparent: true,
                });
