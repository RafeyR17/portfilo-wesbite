...
import { 
    ...
    Rocket, Target, Users, Heart, Camera
} from "lucide-react";
import Navbar from "@/components/Navbar";
import Footer from "@/components/Footer";
import NebulaBackground from "@/components/NebulaBackground";

export default function CircleKeepCaseStudy() {
    return (
        <main className="min-h-screen relative text-white selection:bg-purple-500/30">
            ...
            <div className="max-w-5xl mx-auto px-6 pt-32 pb-20">
                ...
                <div className="mb-16 space-y-6">
                    <h1 className="text-5xl md:text-8xl font-serif font-bold leading-tight text-glow">
                        ...
                        <span className="text-purple-400 block md:inline">
                             – Digital Memory Capsules
                        </span>
                    </h1>
                    <p className="text-xl md:text-2xl text-purple-100/70 max-w-3xl font-sans leading-relaxed">
                        A heartfelt platform for friends, families, and communities to privately preserve and relive shared moments through time-locked memory circles.
                    </p>
                </div>
                ...
                <div className="relative aspect-video rounded-[2.5rem] overflow-hidden glass-premium mb-20 border border-purple-500/30 shadow-[0_0_50px_rgba(168,85,247,0.15)]">
                    <Image
                        src="/projects/circlekeep-preview.png"
                        alt="CircleKeep Hero"
                        fill
                        priority
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
                    <div className="glass-premium p-8 rounded-3xl border border-purple-500/20">
                        <div className="flex items-center gap-3 mb-4 text-purple-400">
                            ...
                            <p className="text-xs uppercase tracking-widest font-bold">Purpose</p>
                        </div>
                        <p className="text-lg font-semibold">Preserving meaningful life milestones</p>
                    </div>
                    <div className="glass-premium p-8 rounded-3xl border border-purple-500/20">
                        <div className="flex items-center gap-3 mb-4 text-purple-400">
                            <Users className="w-6 h-6" />
                            <p className="text-xs uppercase tracking-widest font-bold">Privacy</p>
                        </div>
                        <p className="text-lg font-semibold">End-to-end encrypted 'Memory Vaults'</p>
                    </div>
                    <div className="glass-premium p-8 rounded-3xl border border-purple-500/20">
                        <div className="flex items-center gap-3 mb-4 text-purple-400">
                            <Heart className="w-6 h-6" />
                            <p className="text-xs uppercase tracking-widest font-bold">UX Focus</p>
                        </div>
                        <div className="flex flex-wrap gap-2">
                            {["Next.js", "Supabase", "Stripe", "PostgreSQL"].map(tech => (
                ...
                <div className="space-y-24">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                        ...
                        <div className="lg:col-span-8">
                            <p className="text-lg text-purple-100/80 leading-relaxed font-sans">
                                In an era of disposable digital content, meaningful shared memories often get lost in infinite cloud storage or fragmented chat threads. There is no dedicated space for communities to intentionally &quot;plant&quot; memories to be discovered later, leading to a loss of long-term emotional connection in digital spaces.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                        ...
                        <div className="lg:col-span-8 space-y-8">
                            <p className="text-lg text-purple-100/80 leading-relaxed font-sans">
                                CircleKeep introduces &quot;Temporal Storage.&quot; By using time-locked encryption and event-based triggers, we ensure that memories are delivered when they matter most. It turns digital storage into an emotional experience—a digital &quot;time capsule&quot; that fosters deep connection and nostalgia.
                            </p>
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                {[
                                    "Time-locked &apos;Circles&apos; for scheduled memory reveals",
                                    "Support for high-fidelity audio, video, and notes",
                                    "Event-based triggers (location, milestones)",
                                    "Private, encrypted community memory vaults",
                                    "Immersive playback &apos;Memory Stream&apos; UI"
                                ].map((feature, idx) => (
                    ...
                    <div className="glass-premium p-10 md:p-16 rounded-[3rem] border border-purple-500/20 overflow-hidden relative">
                        <div className="absolute top-0 right-0 p-12 opacity-10 pointer-events-none">
                            <Camera size={200} className="text-purple-500" />
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
                            {[
                                "98% emotional impact score in user tests",
                                "Over 10,000 capsules planted in beta",
                                "Zero data loss via multi-region storage",
                                "Average Circle lifespan: 5+ years",
                                "Used by 500+ private family groups"
                            ].map((metric, idx) => (
                    ...
                    <div className="relative py-12 px-8 text-center bg-gradient-to-b from-purple-500/5 to-transparent rounded-[3rem]">
                        ...
                        <blockquote className="text-2xl md:text-3xl italic text-purple-100/90 leading-relaxed relative z-10 font-serif mb-8 max-w-4xl mx-auto">
                            Opening a circle from three years ago with my late grandmother&apos;s voice was the most powerful digital experience I&apos;ve ever had.
                        </blockquote>
                        <div className="space-y-1">
                            <p className="text-white font-bold text-lg">Elena Rossi</p>
                            <p className="text-purple-400/80 text-sm tracking-widest uppercase">Early Adopter</p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-6 justify-center pt-8">
                        <Link
                            href="https://github.com/RafeyR17/circlekeep"
                            target="_blank"
